...
.btn-copy:hover            { background: var(--color-border-subtle); }
.btn-copy:active           { transform: scale(0.88); }
.btn-copy.copied           { color: var(--color-success); animation: copy-pulse .45s ease-out; }
.btn-copy.copied:hover     { background: transparent; }
