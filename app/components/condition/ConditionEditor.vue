...
<template>
  <div class="cond-editor">
      ...
      <div class="cond-panel-body">
        ...
        <div v-if="kind === ConditionKind.Rule" class="rule-block">
          ...
          <div class="rule-row">
            ...
            <div class="watched-head">
              <div class="watched-meta">
                ...
                <p class="rule-hint">
                  <i18n-t
                    keypath="conditionEditor.watchedFields.hint"
                    tag="span"
                  >
                    <template #dotdot
                      ><code>{{
            ...
            <div v-if="paths.length > 0 || isAdding" class="chips">
              <span v-for="p in paths" :key="p" class="chip">
                ...
                <button type="button" class="chip-x" @click="removePath(p)">
                  ×
                </button>
              </span>
              ...
              >
                <input
                  ...
                  class="chip-input"
                  :placeholder="
                    $t('conditionEditor.watchedFields.inputPlaceholder')
                  "
          ...
          <div class="rule-row inline">
            <span class="rule-label">{{
              $t("conditionEditor.trigger.label")
            }}</span>
    ...
    <div v-if="isPickerOpen" class="overlay" @click.self="closePicker">
      <div class="overlay-box picker-modal">
          ...
          <div class="code-block source-block">
            ...
            <div class="code-body tree-body">
              <div v-if="loading" class="muted">
                {{ $t("conditionEditor.picker.fetching", { url: props.url }) }}
              </div>
        ...
        <div class="picker-foot">
          ...
          <button type="button" class="btn btn-primary" @click="closePicker">
    ...
    <div class="preview-strip" :class="verdictSummary.ok ? 'ok' : 'no'">
...
.rule-hint code {
  ...
  background: var(
    --color-border-subtle
  ); /* theme-aware: dark slate / light gray */
  padding: 1px 5px;
  border-radius: 3px;
  font-family: var(--font-mono);
  font-size: var(--text-sm);
...
.chip-input-wrap.has-error .chip-input-done:hover {
  background: #991b1b;
}
