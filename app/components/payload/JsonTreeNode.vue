...
.branch-name { color: #9cdcfe; font-weight: 600; }
.branch-sep  { color: #9cdcfe; opacity: 0.55; margin-left: 1px; }
.branch-hint {
  color: #9cdcfe;
  opacity: 0.45;
  font-size: 12px;
...
.leaf-name  { color: #9cdcfe; font-weight: 600; white-space: nowrap; }
.leaf-sep   { color: #9cdcfe; opacity: 0.55; }
.leaf-value {
  color: #9cdcfe;
  white-space: nowrap;
  overflow: hidden;
...
.leaf-line:hover .leaf-path { opacity: 0.55; }
</style>
